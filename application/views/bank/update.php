<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			<div class="box-body">
				<?php echo $alert;?>
				<form action="../AkunBank/saveDataUpdate" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Apakah anda yakin ingin menyimpan ini ?');">
                <input type="hidden" class="form-control" name="id_akun" value="<?php echo $mydata['id_akun'];?>">
