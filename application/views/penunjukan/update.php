	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<form action="../penunjukan/savedataupdate" method="POST" onsubmit="return confirm('Apakah anda yakin ingin menyimpan ini ?');">
					<input type="hidden" name="kode_penunjukan" value="<?php echo $mydata['kode_penunjukan'];?>">
