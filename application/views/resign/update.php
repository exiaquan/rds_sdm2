	...
	<div class="col-md-12">
		<div class="box box-primary">
			<div class="box-body">
				<?php echo $alert;?>
				<form action="../resign/saveDataUpdate" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Apakah anda yakin ingin menyimpan ini ?');" enctype="multipart/form-data">
				<input type="hidden" class="form-control" name="kode_resign" value="<?php echo $mydata['kode_resign'];?>">
					...
					<div class="col-md-10">
							...
							<input type="hidden" name="old_file_resign" value="<?php echo $mydata['file'];?>">
							<small class="text-info"><?php if($mydata['file'] != NULL){echo '<a href="'.base_url().'assets/file/'.$mydata['kode_resign'].'/'.$mydata['file'].'">'.$mydata['file'].'</a>';}?></small>
						</div>
					</div>
            		<div class="col-md-12" style="margin-top:10px;">
